...
namespace GraduationProject {
	...
	private: System::Windows::Forms::ToolStripMenuItem^ readCalibrationToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		/// </summary>
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   this->saveCalibrationToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			   this->readCalibrationToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			   ...
			   this->menuStrip1->Size = System::Drawing::Size(1423, 24);
			   ...
			   this->fileToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(6) {
				   this->openToolStripMenuItem,
					   this->showEdgesToolStripMenuItem, this->showLinesToolStripMenuItem, this->saveCalibrationToolStripMenuItem, this->readCalibrationToolStripMenuItem,
			   ...
			   this->openToolStripMenuItem->Click += gcnew System::EventHandler(this, &CalibrationForm::openToolStripMenuItem_Click);
			   // 
			   // showEdgesToolStripMenuItem
			   // 
			   this->showEdgesToolStripMenuItem->Name = L"showEdgesToolStripMenuItem";
			   this->showEdgesToolStripMenuItem->Size = System::Drawing::Size(161, 22);
			   this->showEdgesToolStripMenuItem->Text = L"Show Edges";
			   this->showEdgesToolStripMenuItem->Click += gcnew System::EventHandler(this, &CalibrationForm::showEdgesToolStripMenuItem_Click);
			   // 
			   // showLinesToolStripMenuItem
			   // 
			   this->showLinesToolStripMenuItem->Name = L"showLinesToolStripMenuItem";
			   this->showLinesToolStripMenuItem->Size = System::Drawing::Size(161, 22);
			   this->showLinesToolStripMenuItem->Text = L"Show Lines";
			   this->showLinesToolStripMenuItem->Click += gcnew System::EventHandler(this, &CalibrationForm::showLinesToolStripMenuItem_Click);
			   // 
			   // saveCalibrationToolStripMenuItem
			   // 
			   this->saveCalibrationToolStripMenuItem->Name = L"saveCalibrationToolStripMenuItem";
			   this->saveCalibrationToolStripMenuItem->Size = System::Drawing::Size(161, 22);
			   this->saveCalibrationToolStripMenuItem->Text = L"Save Calibration";
			   this->saveCalibrationToolStripMenuItem->Click += gcnew System::EventHandler(this, &CalibrationForm::saveCalibrationToolStripMenuItem_Click);
			   // 
			   // readCalibrationToolStripMenuItem
			   // 
			   this->readCalibrationToolStripMenuItem->Name = L"readCalibrationToolStripMenuItem";
			   this->readCalibrationToolStripMenuItem->Size = System::Drawing::Size(161, 22);
			   this->readCalibrationToolStripMenuItem->Text = L"Read Calibration";
			   this->readCalibrationToolStripMenuItem->Click += gcnew System::EventHandler(this, &CalibrationForm::readCalibrationToolStripMenuItem_Click);
			   // 
			   // testToolStripMenuItem
			   // 
			   this->testToolStripMenuItem->Name = L"testToolStripMenuItem";
			   this->testToolStripMenuItem->Size = System::Drawing::Size(161, 22);
			   this->testToolStripMenuItem->Text = L"Test";
			   this->testToolStripMenuItem->Click += gcnew System::EventHandler(this, &CalibrationForm::testToolStripMenuItem_Click);
			   // 
			   // pictureBox1
			   // 
			   this->pictureBox1->Location = System::Drawing::Point(13, 29);
			   this->pictureBox1->Name = L"pictureBox1";
			   this->pictureBox1->Size = System::Drawing::Size(688, 557);
			   this->pictureBox1->TabIndex = 1;
			   this->pictureBox1->TabStop = false;
			   this->pictureBox1->MouseClick += gcnew System::Windows::Forms::MouseEventHandler(this, &CalibrationForm::pictureBox1_MouseClick);
			   // 
			   // openFileDialog1
			   // 
			   ...
			   // CalibButton
			   // 
			   this->CalibButton->Location = System::Drawing::Point(984, 192);
			   this->CalibButton->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			   this->CalibButton->Name = L"CalibButton";
			   this->CalibButton->Size = System::Drawing::Size(96, 49);
			   this->CalibButton->TabIndex = 2;
			   this->CalibButton->Text = L"Calibration";
			   this->CalibButton->UseVisualStyleBackColor = true;
			   this->CalibButton->Click += gcnew System::EventHandler(this, &CalibrationForm::CalibButton_Click);
			   // 
			   // richTextBox1
			   // 
			   this->richTextBox1->Location = System::Drawing::Point(940, 261);
			   this->richTextBox1->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			   this->richTextBox1->Name = L"richTextBox1";
			   this->richTextBox1->Size = System::Drawing::Size(210, 206);
			   this->richTextBox1->TabIndex = 3;
			   this->richTextBox1->Text = L"";
			   // 
			   // WorldCoordEnter
			   // 
			   this->WorldCoordEnter->Location = System::Drawing::Point(1255, 105);
			   this->WorldCoordEnter->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			   this->WorldCoordEnter->Name = L"WorldCoordEnter";
			   this->WorldCoordEnter->Size = System::Drawing::Size(74, 32);
			   this->WorldCoordEnter->TabIndex = 4;
			   this->WorldCoordEnter->Text = L"Enter";
			   this->WorldCoordEnter->UseVisualStyleBackColor = true;
			   this->WorldCoordEnter->Click += gcnew System::EventHandler(this, &CalibrationForm::WorldCoordEnter_Click);
			   // 
			   // xCoordtextB
			   // 
			   this->xCoordtextB->Location = System::Drawing::Point(1230, 73);
			   this->xCoordtextB->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			   this->xCoordtextB->Name = L"xCoordtextB";
			   this->xCoordtextB->Size = System::Drawing::Size(27, 20);
			   this->xCoordtextB->TabIndex = 5;
			   // 
			   // zCoordtextB
			   // 
			   this->zCoordtextB->Location = System::Drawing::Point(1326, 73);
			   this->zCoordtextB->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			   this->zCoordtextB->Name = L"zCoordtextB";
			   this->zCoordtextB->Size = System::Drawing::Size(27, 20);
			   this->zCoordtextB->TabIndex = 6;
			   // 
			   // label1
			   // 
			   this->label1->AutoSize = true;
			   this->label1->Location = System::Drawing::Point(1227, 43);
			   ...
			   // yCoordtextB
			   // 
			   this->yCoordtextB->Location = System::Drawing::Point(1279, 73);
			   this->yCoordtextB->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			   this->yCoordtextB->Name = L"yCoordtextB";
			   this->yCoordtextB->Size = System::Drawing::Size(27, 20);
			   this->yCoordtextB->TabIndex = 9;
			   // 
			   // calcButton
			   // 
			   this->calcButton->Location = System::Drawing::Point(1166, 192);
			   this->calcButton->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			   this->calcButton->Name = L"calcButton";
			   this->calcButton->Size = System::Drawing::Size(96, 49);
			   this->calcButton->TabIndex = 10;
			   this->calcButton->Text = L"Calculate World\r\n Coordinate";
			   this->calcButton->UseVisualStyleBackColor = true;
			   this->calcButton->Click += gcnew System::EventHandler(this, &CalibrationForm::calcButton_Click);
			   // 
			   // richTextBox2
			   // 
			   this->richTextBox2->Location = System::Drawing::Point(1179, 261);
			   this->richTextBox2->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			   this->richTextBox2->Name = L"richTextBox2";
			   this->richTextBox2->Size = System::Drawing::Size(174, 206);
			   ...
			   this->AutoRadioButton->Location = System::Drawing::Point(951, 53);
			   this->AutoRadioButton->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			   this->AutoRadioButton->Name = L"AutoRadioButton";
			   this->AutoRadioButton->Size = System::Drawing::Size(47, 17);
			   ...
			   this->ManuelRadioButton->Location = System::Drawing::Point(1010, 53);
			   this->ManuelRadioButton->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			   this->ManuelRadioButton->Name = L"ManuelRadioButton";
			   this->ManuelRadioButton->Size = System::Drawing::Size(60, 17);
			   ...
			   // measureButton
			   // 
			   this->measureButton->Location = System::Drawing::Point(1281, 192);
			   this->measureButton->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			   this->measureButton->Name = L"measureButton";
			   this->measureButton->Size = System::Drawing::Size(96, 46);
			   ...
			   this->measureButton->Click += gcnew System::EventHandler(this, &CalibrationForm::measureButton_Click);
			   // 
			   // checkBox1
			   // 
			   this->checkBox1->AutoSize = true;
			   this->checkBox1->Location = System::Drawing::Point(1281, 170);
			   ...
			   this->checkBox1->CheckedChanged += gcnew System::EventHandler(this, &CalibrationForm::checkBox1_CheckedChanged);
			   // 
			   // manuelGetFile
			   // 
			   this->manuelGetFile->AutoSize = true;
			   this->manuelGetFile->Location = System::Drawing::Point(1086, 53);
			   this->manuelGetFile->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			   this->manuelGetFile->Name = L"manuelGetFile";
			   this->manuelGetFile->Size = System::Drawing::Size(105, 17);
			   ...
			   this->label2->Location = System::Drawing::Point(942, 469);
			   ...
			   this->ClientSize = System::Drawing::Size(1423, 597);
...
#pragma endregion
		   ...
		   void openToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
			   ...
			   if (openFileDialog1->ShowDialog() == System::Windows::Forms::DialogResult::OK) {
				   ...
				   image smoothim = Smoothing(grayim, 5);				// smoothing
				   ...
				   if (AutoRadioButton->Checked) {
						   FILE* worldFile;
						   worldFile = fopen("Data/Worldpoints.txt", "r");
						   rewind(worldFile);
						   float* world = new float[numofpoints * 3];
						   for (int i = 0; i < numofpoints; i++) {
							   fscanf(worldFile, "%f", &world[i * 3 + 0]);
							   fscanf(worldFile, "%f", &world[i * 3 + 1]);
							   fscanf(worldFile, "%f", &world[i * 3 + 2]);
						   }
						   Compute_Projection_Matrix(numofpoints, world, Points, Projection);
						   isCalib = true;
						   for (int i = 0; i < 3; i++)
						   {
	...
	private: System::Void measureButton_Click(System::Object^ sender, System::EventArgs^ e) {
		if (measurePCount == 2)
		{
			...
			richTextBox2->AppendText("Distance : " + distance + " mm" + "\n");
			measurePCount = 0;
		}
	}

	private: System::Void saveCalibrationToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
		if (isCalib)
		{
		...
		{
			MessageBox::Show("Calibrate first.");
		}
	}
	private: System::Void readCalibrationToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
