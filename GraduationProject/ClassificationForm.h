...
namespace GraduationProject {
	...
	/// </summary>
	public ref class ClassificationForm : public System::Windows::Forms::Form
	{
	public:
		ClassificationForm(void)
		{
			srand(time(0));
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   this->button1->Click += gcnew System::EventHandler(this, &ClassificationForm::button1_Click);
			   // 
			   // label6
			   // 
			   ...
			   this->readDataToolStripMenuItem->Click += gcnew System::EventHandler(this, &ClassificationForm::readDataToolStripMenuItem_Click);
			   // 
			   ...
			   this->readWeightsToolStripMenuItem->Click += gcnew System::EventHandler(this, &ClassificationForm::readWeightsToolStripMenuItem_Click);
			   // 
			   ...
			   this->saveWeightsToolStripMenuItem->Click += gcnew System::EventHandler(this, &ClassificationForm::saveWeightsToolStripMenuItem_Click);
			   // 
			   // openFileDialog1
			   // 
			   ...
			   this->button3->Click += gcnew System::EventHandler(this, &ClassificationForm::button3_Click);
			   // 
			   // button2
			   // 
			   ...
			   this->button2->Click += gcnew System::EventHandler(this, &ClassificationForm::button2_Click);
			   // 
			   // Form1
			   // 
